        ...
        <div className="font-[sans-serif]">
          <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
            <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl max-md:max-w-md w-full">
              <div>
                <h2 className="lg:text-5xl text-3xl font-extrabold lg:leading-[55px]" style={{ color: 'var(--white)' }}>
                  Seamless Login for Exclusive Access
                </h2>
                <p className="text-sm mt-6" style={{ color: 'var(--white)' }}>
                ...
                <p className="text-sm mt-12" style={{ color: 'var(--white)' }}>
                  Don't have an account <a href="javascript:void(0);" className="text-blue-600 font-semibold hover:underline ml-1">Register here</a>
                </p>
              </div>

              <form className="max-w-md md:ml-auto w-full">
                <h3 className="text-gray-800 text-3xl font-extrabold mb-8" style={{ color: 'var(--white)' }}>
                  Sign in
                </h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="flex items-center">
                      ...
                      />
                      <label for="remember-me" className="ml-3 block text-sm" style={{ color: 'var(--white)' }}>
                        Remember me
                      </label>
                    </div>
                ...
                <div className="my-4 flex items-center gap-4">
                  ...
                  <p className="text-sm" style={{ color: 'var(--white)' }} text-center>or</p>
                  <hr className="w-full border-gray-300" />
                </div>
